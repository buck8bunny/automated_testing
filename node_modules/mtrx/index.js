const reduce = require('mtrx/src/reduce'),
      every = require('mtrx/src/every'),
      some = require('mtrx/src/some'),
      map = require('mtrx/src/map'),

      isDiag = require('mtrx/src/isDiag'),
      isNumbers = require('mtrx/src/isNumbers'),
      isMtrxLike = require('mtrx/src/isMtrxLike'),
      isSingular = require('mtrx/src/isSingular'),
      isSameShape = require('mtrx/src/isSameShape'),

      transpose = require('mtrx/src/transpose'),
      multiply = require('mtrx/src/multiply'),
      inverse = require('mtrx/src/inverse'),
      compan = require('mtrx/src/compan'),
      clone = require('mtrx/src/clone'),
      rank = require('mtrx/src/rank'),
      det = require('mtrx/src/det'),
      lup = require('mtrx/src/lup'),
      cof = require('mtrx/src/cof'),

      reset = require('mtrx/src/reset');
